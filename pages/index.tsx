        ...
        <div className="flex md:flex-row flex-col items-center mt-8">
          ...
          <div className="lg:flex-grow md:w-1/2 lg:pl-24 md:pl-16 flex flex-col md:items-start md:text-left items-center text-center">
            <div className="flex flex-col mb-8 text-left">
              <p>
                はじめまして！私のポートフォリオサイトへようこそ！<br/>
                岡山県出身で現在北海道札幌市を拠点に生活しております。<br/>
              ...
              <div className="flex justify-start mt-4">
                ...
                <a className="text-indigo-400 ml-2" href="https://github.com/KeisukeShimamura" target="_blank" rel="noreferrer">https://github.com/KeisukeShimamura</a>
              </div>
            </div>
          </div>
        </div>
...
export const getStaticProps: GetStaticProps<IndexProps> = async () => {
  const expertises = await client.get({ endpoint: 'expertises', queries: {orders: 'publishedAt'} })
