  ...
  return (
    <form onSubmit={onSubmit} className="mx-2 md:mx-32 lg:mx-64 mt-12">
      <div className="mb-6">
        ...
        <input type="text" className="border border-indigo-500 text-gray-900 text-sm rounded-md w-full p-2"
      ...
      <div className="mb-6">
        ...
        <input type="email" className="border border-indigo-500 text-gray-900 text-sm rounded-md w-full p-2"
          {...register("email", {
            required: "必須項目です。",
            pattern: {
      ...
      <div className="mb-6">
        ...
        <textarea className="border border-indigo-500 text-gray-900 text-sm rounded-md w-full p-2 h-32" placeholder="Type your message…"
          {...register("message", {
            required: "必須項目です。",
            maxLength: {
              value: 1000,
